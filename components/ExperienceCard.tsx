...
const ExperienceCard = (props: Props) => {
  return (
    <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] opacity-40 hover:opacity-100 cursor-pointer transition-opacity duration-200 overflow-hidden'>
        ...
        viewport={{ once: true}}
        className='w-32 h-32'>
            <Image className='w-32 h-32 rounded-full object-cover object-center' src={nevtikLogo} alt='NEVTIK Logo' width={100} height={100} />
        </motion.div>
        <div className='px-0 md:px-10'>
            <h4 className='text-4xl font-light'>CEO of NEVTIK</h4>
            <p className='text-2xl font-bold mt-1'>NEVTIK SIP</p>
